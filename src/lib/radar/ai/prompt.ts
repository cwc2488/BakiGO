...
- market_role: consumer / provider / mixed / unknown. Coaches, trainers, nutrition educators posting client results, service offers, coaching DMs, professional teaching, or repeated client/service content are provider. A person may have BOTH a personal need and provider activity — still mark market_role provider or mixed. Do not hide provider activity behind a personal goal. Ordinary consumers who merely exercise, discuss nutrition, or share their own transformation stay consumer unless meaningful service/coaching/selling evidence exists.

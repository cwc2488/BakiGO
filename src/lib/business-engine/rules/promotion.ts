...
export const MEMBER_RANK_TO_PROMOTION_RANK: Record<string, PromotionRankId> = {
  ...
  active_supervisor: PROMOTION_RANK_IDS.ACTIVE_SUPERVISOR,
...
export const DEFAULT_PROMOTION_TREE: PromotionTree = {
  ...
  ranks: {
    ...
    [PROMOTION_RANK_IDS.SUPERVISOR]: {
      ...
      nextRank: PROMOTION_RANK_IDS.ACTIVE_SUPERVISOR,
      requirement: null,
      description: "MAP 計劃：連續三個月 1000 VP ＋ 招募兩位達標會員。",
      badge: "badge_supervisor",
      themeColor: "#77b539",
    },
    [PROMOTION_RANK_IDS.ACTIVE_SUPERVISOR]: {
      rankId: PROMOTION_RANK_IDS.ACTIVE_SUPERVISOR,
      name: "活躍督導",
      parentRank: PROMOTION_RANK_IDS.SUPERVISOR,
      nextRank: PROMOTION_RANK_IDS.WORLD_TEAM,
      requirement: null,
      description: "督導連續三個月 2500 VP 以上。",
      badge: "badge_active_supervisor",
      themeColor: "#5856d6",
    },
    [PROMOTION_RANK_IDS.WORLD_TEAM]: {
      rankId: PROMOTION_RANK_IDS.WORLD_TEAM,
      name: "世界組",
      parentRank: PROMOTION_RANK_IDS.ACTIVE_SUPERVISOR,

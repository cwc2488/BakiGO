 ...
 * Never includes auth, personal calendar events, customers, pending mutations,
 * or other syncable user content.
 */
...
export function reclaimDisposableLocalCaches(
  storage: Pick<
    { getItem(key: string): string | null; removeItem(key: string): void },
    "getItem" | "removeItem"
  > = {
